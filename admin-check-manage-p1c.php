...
<div role="tabpanel" class="tab-pane <?=($PHASEACTIVE=='c1')?'active':'';?>" id="confirm1">
    ...
    <?php else: ?>
        <?php if(!isset($PHASE1['id'])): ?>
            <div class="text-center" style="padding-top: 50px; color: red">
                <h3> ไม่สามารถดำเนินการได้ </h3>
            </div>
        <?php elseif($PHASE1['result']=='process'): ?>
        ...
        <?php else: ?>
            <div style="padding-top: 20px; padding-bottom: 10px;">
                ...
                ?>
                <form id="radioChangeConfirm1Result" class="bs-callout <?=$bs_callout;?>" method="post" autocomplete="off">
                    <h4>ตรวจโครงการ</h4>
                    <div class="radio">
                        <label>
                            <input type="radio" name="confirm1result" value="process" <?= $phase1_result=='process'?'checked':''?>>
                            <strong>รอ</strong> รอการตรวจสอบจากคณะกรรมการ
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="confirm1result" value="fail" <?= $phase1_result=='fail'?'checked':''?> >
                            <strong>ไม่ผ่าน</strong> โครงการไม่ผ่านการคัดเลือก
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="confirm1result" value="pass" <?= $phase1_result=='pass'?'checked':''?>>
                            <strong>ผ่าน</strong> โครงการผ่านการคัดเลือก
                        </label>
                    </div>
                    <div class="text-center" style="padding-top: 20px;">
                        <input class="hidden" name="fn" value="editConfirm1Result">
                        <input class="hidden" name="phase_id" value="<?=$CP1['id'];?>" >
