...
-- Dumping data for table db_b2i.b2i_post: ~0 rows (approximately)
/*!40000 ALTER TABLE `b2i_post` DISABLE KEYS */;
/*!40000 ALTER TABLE `b2i_post` ENABLE KEYS */;

-- Dumping structure for table db_b2i.b2i_post_comment
...
-- Dumping data for table db_b2i.b2i_post_comment: ~0 rows (approximately)
/*!40000 ALTER TABLE `b2i_post_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `b2i_post_comment` ENABLE KEYS */;

-- Dumping structure for table db_b2i.b2i_post_upload
...
-- Dumping data for table db_b2i.b2i_post_upload: ~0 rows (approximately)
/*!40000 ALTER TABLE `b2i_post_upload` DISABLE KEYS */;
/*!40000 ALTER TABLE `b2i_post_upload` ENABLE KEYS */;

-- Dumping structure for table db_b2i.b2i_project
...
-- Dumping data for table db_b2i.b2i_project: ~2 rows (approximately)
/*!40000 ALTER TABLE `b2i_project` DISABLE KEYS */;
INSERT INTO `b2i_project` (`id`, `projectsetup_id`, `name`, `schoolname`, `schoolregion`, `detail`, `createat`, `updateat`) VALUES
	(1, 1, 'ดอกไม้กระดาษ', 'บ้านหว้านใหญ่', 'ตะวันออกเฉียงเหนือ', '', '2018-05-30 17:07:04', '2018-05-30 17:07:04'),
	(2, 1, 'ดอกไม้กระดาษ', 'บ้านหว้านใหญ่', 'กลาง', '', '2018-05-30 17:10:09', '2018-05-30 17:10:09');
/*!40000 ALTER TABLE `b2i_project` ENABLE KEYS */;

-- Dumping structure for table db_b2i.b2i_projectsetup
...
-- Dumping data for table db_b2i.b2i_projectsetup: ~1 rows (approximately)
...
-- Dumping structure for table db_b2i.b2i_projectsetup_image
...
-- Dumping data for table db_b2i.b2i_projectsetup_image: ~1 rows (approximately)
/*!40000 ALTER TABLE `b2i_projectsetup_image` DISABLE KEYS */;
INSERT INTO `b2i_projectsetup_image` (`id`, `namefile`, `path`, `createat`) VALUES
	(6, 'null', '/upload/image/image_1527750961.png', '2018-05-31 14:16:07');
/*!40000 ALTER TABLE `b2i_projectsetup_image` ENABLE KEYS */;

-- Dumping structure for table db_b2i.b2i_project_member
...
-- Dumping data for table db_b2i.b2i_project_member: ~0 rows (approximately)
...
-- Dumping data for table db_b2i.b2i_project_phase: ~0 rows (approximately)
...
-- Dumping data for table db_b2i.b2i_project_phase_log: ~0 rows (approximately)
...
-- Dumping data for table db_b2i.b2i_project_phase_upload: ~0 rows (approximately)
...
-- Dumping data for table db_b2i.b2i_user: ~3 rows (approximately)
