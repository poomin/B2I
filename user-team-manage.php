...
require_once __DIR__ . '/controller/userTeamManage.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div>
                        ...
                        <form class="form-horizontal">
                                    ...
                                    <label class="control-label" id="memberShow">
                                        ...
                                        foreach ($MEMBERS as $item): ?>
                                            <?php if($item['membertype']=='member'):
                                                ...
                                                ?>
                                                <p id="member<?=$item['id'];?>"> <?=$item['name'].' '.$item['surname'];?> <i class="fa fa-close i-close" onclick="deleteMember('<?=$item['id'];?>')" ></i></p>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </label>
                                    <br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="schoolname" name="schoolname" value="<?=$PROJECT['schoolname'];?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="schoolregion">
                                        <option value="กลาง" <?=$PROJECT['schoolregion']=='กลาง'?'selected':'';?> >กลาง</option>
                                        <option value="เหนือ" <?=$PROJECT['schoolregion']=='เหนือ'?'selected':'';?> >เหนือ</option>
                                        <option value="ตะวันออก" <?=$PROJECT['schoolregion']=='ตะวันออก'?'selected':'';?> >ตะวันออก</option>
                                        <option value="ตะวันตก" <?=$PROJECT['schoolregion']=='ตะวันตก'?'selected':'';?> >ตะวันตก</option>
                                        <option value="ตะวันออกเฉียงเหนือ" <?=$PROJECT['schoolregion']=='ตะวันออกเฉียงเหนือ'?'selected':'';?> >ตะวันออกเฉียงเหนือ</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="4" class="form-control" id="projectDetail" name="detail"><?=$PROJECT['detail'];?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10 text-center">
                                    ...
                                    <input id="memberall" class="hidden" name="member" value="<?=$list_id?>">
                                    <input class="hidden" name="fn" value="editProject">
