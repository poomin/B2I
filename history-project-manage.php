                ...
                <div class="box-card" style="min-height: 300px;">
                    ...
                    <div>
                        ...
                        <div class="tab-content">
                            ...
                            <?php include  'history-project-manage-p1.php';?>
                            <?php include  'history-project-manage-p1c.php';?>

                            <?php include  'history-project-manage-p2.php';?>
                            <?php include  'history-project-manage-p2c.php';?>

                            <?php include  'history-project-manage-p3.php';?>
